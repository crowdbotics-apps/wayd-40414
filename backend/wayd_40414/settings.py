"""
Django settings for wayd_40414 project.
...
WSGI_APPLICATION = 'wayd_40414.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wayd_40414 API",
    "DESCRIPTION": "API documentation for wayd_40414 App",
    "VERSION": "v1",
}
